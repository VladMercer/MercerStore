...
namespace MercerStore.Controllers.Api
{
    ...
    public class ReviewApiController : ControllerBase
    {
        ...
        public ReviewApiController(IReviewProductRepository reviewProductRepository)
        {
        ...
        [HttpGet("GetCountProductReviews")]
        ...
        [HttpDelete("RemoveReview/{productId}")]
