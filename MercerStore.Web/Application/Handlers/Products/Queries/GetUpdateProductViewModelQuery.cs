...
namespace MercerStore.Web.Application.Handlers.Products.Queries
{
    ...
    public class GetUpdateProductViewModelHandler : IRequestHandler<GetUpdateProductViewModelQuery, UpdateProductViewModel>
    {
        ...
        public async Task<UpdateProductViewModel> Handle(GetUpdateProductViewModelQuery request, CancellationToken cancellationToken)
        {
            return await _productService.GetUpdateProductViewModel(request.ProductId);
        }
    }
}
