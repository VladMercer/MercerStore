...
namespace MercerStore.Web.Application.Handlers.Orders.Commands
{
    ...
    public class RemoveOrderProductHandler : IRequestHandler<RemoveOrderProductCommand, Unit>
    {
        ...
        public async Task<Unit> Handle(RemoveOrderProductCommand request, CancellationToken cancellationToken)
        {
            await _orderService.RemoveOrderProduct(request.OrderId, request.ProductId);
