...
namespace MercerStore.Web.Application.Handlers.Home.Queries
{
    ...
    public class HomeHandler : IRequestHandler<GetHomePageProductQuery, HomePageViewModel>
    {
        ...
        public async Task<HomePageViewModel> Handle(GetHomePageProductQuery request, CancellationToken cancellationToken)
        {
            return await _homeService.GetHomePageProduct();
        }
    }
}
