...
public class GetCategoryPageViewModelHandler : IRequestHandler<GetCategoryPageViewModelQuery, CategoryPageViewModel>
{
    ...
    public async Task<CategoryPageViewModel> Handle(GetCategoryPageViewModelQuery request,
        CancellationToken ct)
    {
        return await _categoryService.GetCategoryPageViewModel(request.CategoryId, ct);
    }
}