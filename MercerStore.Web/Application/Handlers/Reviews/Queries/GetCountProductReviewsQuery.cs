...
namespace MercerStore.Web.Application.Handlers.Reviews.Queries
{
    ...
    public class GetCountProductReviewsHandler : IRequestHandler<GetCountProductReviewsQuery, int>
    {
        ...
        public async Task<int> Handle(GetCountProductReviewsQuery request, CancellationToken cancellationToken)
        {
            return await _reviewService.GetCountProductReviews(request.ProductId);
        }
    }
}
