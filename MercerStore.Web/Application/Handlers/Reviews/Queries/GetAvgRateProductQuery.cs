...
namespace MercerStore.Web.Application.Handlers.Reviews.Queries
{
    ...
    public class GetAvgRateProductHandler : IRequestHandler<GetAvgRateProductQuery, double>
    {
        ...
        public async Task<double> Handle(GetAvgRateProductQuery request, CancellationToken cancellationToken)
        {
            return await _reviewService.GetAvgRateProduct(request.ProductId);
        }
    }
}
