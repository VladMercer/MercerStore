...
namespace MercerStore.Web.Infrastructure.Services
{
    public class ElasticSearchService : IElasticSearchService
    {
        ...
        public async Task IndexProductAsync(Product product)
        {
            ...
            var response = await _elasticClient.IndexDocumentAsync(indexProduct);
            if (!response.IsValid)
            {
        ...
        public async Task<IEnumerable<ProductIndexDto>> SearchProductsAsync(string searchString)
        {
