...
namespace MercerStore.Web.Migrations
{
    ...
    [Migration("20250111202716_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MercerStore.Web.Models.New.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MercerStore.Web.Models.New.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MercerStore.Web.Models.New.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MercerStore.Web.Models.New.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MercerStore.Web.Models.New.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BrandCategory", b =>
                {
                    b.HasOne("MercerStore.Web.Models.New.Brand", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MercerStore.Web.Models.Carts.CartProduct", b =>
                {
                    ...
                    b.HasOne("MercerStore.Web.Models.New.Product", "Product")
                        .WithOne("CartProduct")
            ...
            modelBuilder.Entity("MercerStore.Web.Models.Products.ProductDescription", b =>
                {
                    b.HasOne("MercerStore.Web.Models.New.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandId");
