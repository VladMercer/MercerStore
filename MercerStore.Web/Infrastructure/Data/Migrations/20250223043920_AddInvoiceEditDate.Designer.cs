...
namespace MercerStore.Web.Migrations
{
    ...
    [Migration("20250223043920_AddInvoiceEditDate")]
    partial class AddInvoiceEditDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MercerStore.Web.Models.sales.OfflineSale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MercerStore.Web.Models.Invoice.Invoice", b =>
                {
                    b.HasOne("MercerStore.Web.Models.Invoice.Supplier", "Supplier")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("MercerStore.Web.Models.Invoice.InvoiceItem", b =>
                {
                    b.HasOne("MercerStore.Web.Models.Invoice.Invoice", "Invoice")
            ...
            modelBuilder.Entity("MercerStore.Web.Models.sales.OfflineSaleItem", b =>
                {
                    b.HasOne("MercerStore.Web.Models.sales.OfflineSale", "Sale")
                        .WithMany("Items")
